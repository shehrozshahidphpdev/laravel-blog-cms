    ...
    <div class="bg-white border border-gray-200 rounded-2xl shadow-sm overflow-hidden">
      ...
      <form action="{{ route('categories.store') }}" method="POST">
        ...
        <div class="px-6 py-5 border-b border-gray-100">
          <h2 class="text-xs font-semibold text-gray-500 uppercase tracking-wider">Category Information</h2>
        </div>
        ...
        <div class="px-6 py-6 grid grid-cols-1 gap-5 sm:grid-cols-2">
          ...
          <div>
            ...
            <input id="name" name="name" type="text" value="{{ old('name') }}" placeholder="e.g information"
          ...
          {{-- <div>
            <label class="block text-sm font-medium text-gray-700 mb-1.5" for="email">
              status <span class="text-gray-500">(optional) Default is active</span>
            </label>
