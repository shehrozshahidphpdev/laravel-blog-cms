        ...
        <div class="px-6 py-6 grid grid-cols-1 gap-5 sm:grid-cols-2">
          ...
          <div>
            <label class="block text-sm font-medium text-gray-700 mb-1.5" for="status">
              Status
              <span class="text-gray-400 font-normal text-xs">(optional — defaults is active)</span>
            </label>
          ...
          <div class="col-span-2">
            ...
            <input id="title" name="title" type="text" value="{{ old('title') }}" placeholder="Enter post title"
          ...
          <div class="sm:col-span-2">
            ...
            <textarea name="content" id="content" rows="8"
              class="w-full border border-gray-200 rounded-lg px-3 py-2.5 text-sm text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-900 focus:border-transparent transition">{{ old('content') }}</textarea>
            @error('content')
              <p class="text-xs text-red-500 mt-1">{{ $message }}</p>
            @enderror
          </div>
